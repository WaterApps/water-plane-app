...
//        float x = 0.0f;
        ...
        //display on screen
        MainActivity.f64iv.setImageBitmap(b);
        //MainActivity.f64iv.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
    }
